    ...
    content: |
      {
        ...
        "mainEntity": [
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "最低限のLLMOベースライン（llms.txt、/ai/ Markdown、GPTBot/ClaudeBot/PerplexityBotを許可するrobots.txt、主要ページのJSON-LD）は小規模サイトで約30分。LLMOフレームワークで13/15を達成するには通常数週間の漸進的な作業が必要です。"
            }
          },
          {
            "@type": "Question",
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "はい。静的サイトはLLMOの理想的なターゲット — 全コンポーネント（llms.txt, /ai/ Markdown, JSON-LD, robots.txt, sitemap.xml）は静的ファイル。あなたが今読んでいるサイトは GitHub Pages 上の静的Astroサイトで、LLMOフレームワーク 15/15。"
            }
          },
          {
            "@type": "Question",
...
- **数週間**: [LLMOフレームワーク](/ja/framework/overview/) で 13/15 を達成。大半の時間はサイト全体の権威・引用シグナルに使われます。
