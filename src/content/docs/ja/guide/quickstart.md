...
LLMOは何から始めればいいか。実践は3つのファイルから始まる。これらを追加するだけで、サイトをAIに発見可能な状態にできる。所要時間は30分。このガイドではLLMOの最小限の実装を解説する。概念から知りたい方は、先に [LLMOとは何か](/ja/guide/what-is-llmo/) を読んでから戻ってきてほしい。
