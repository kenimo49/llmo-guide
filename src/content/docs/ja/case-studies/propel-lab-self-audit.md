---
title: "自社監査: LLMOリファレンスサイト2つで見つかった20件"
description: "LLMOフレームワークのチームが自身の本番サイト2つ（propel-lab.co.jp と kaoriq.com）を2026年5月に監査した。二段レビュー（自己 → 独立AI）が SEO・構造化データ・コンテンツ整合性にまたがる20件の問題を発見した — チームが数ヶ月運用していた silent JSON-LD drop も含む。"
pubDate: 2026-05-08
---

> **対象**: 同じプレイブック・同じレビュアーで構築された2サイトを併せて監査する。**(propel-lab)** ラベルは [propel-lab.co.jp](https://propel-lab.co.jp/)、**(kaoriq)** ラベルは [kaoriq.com](https://kaoriq.com/) に該当。両サイトに該当する発見もある。
