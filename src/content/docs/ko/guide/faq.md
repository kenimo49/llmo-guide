    ...
    content: |
      {
        ...
        "mainEntity": [
          ...
          {"@type": "Question", "name": "LLMO 구현에 얼마나 걸립니까?", "acceptedAnswer": {"@type": "Answer", "text": "최소 LLMO 기준선(llms.txt, /ai/ Markdown, GPTBot/ClaudeBot/PerplexityBot 허용 robots.txt, 주요 페이지 JSON-LD)은 소규모 사이트에서 약 30분. LLMO 프레임워크에서 16/18 달성에는 보통 몇 주의 점진적 작업이 필요."}},
          ...
          {"@type": "Question", "name": "정적 사이트(백엔드 없음)에서도 LLMO를 구현할 수 있습니까?", "acceptedAnswer": {"@type": "Answer", "text": "네. 정적 사이트는 LLMO의 이상적 타겟 — 모든 컴포넌트(llms.txt, /ai/ Markdown, JSON-LD, robots.txt, sitemap.xml)가 정적 파일. 지금 읽고 있는 사이트는 GitHub Pages의 정적 Astro 사이트로 LLMO 프레임워크 18/18."}},
...
- **몇 주**: [LLMO 프레임워크](/ko/framework/overview/)에서 16/18 달성.
...
네. 모든 컴포넌트가 정적 파일. 이 사이트도 GitHub Pages의 정적 Astro 사이트로 18/18.
