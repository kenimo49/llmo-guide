...
**LLMO는 어떻게 하나?** 실제로는 파일 3개부터 시작한다. 이 파일들만 추가하면 30분 안에 사이트를 AI가 발견할 수 있도록 만들 수 있다. 이 가이드는 최소한의 LLMO 구현 방법을 다룬다. 개념부터 보려면 [What is LLMO?](/ko/guide/what-is-llmo/)를 먼저 읽고 돌아오라.
