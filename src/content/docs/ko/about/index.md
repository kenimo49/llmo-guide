...
본 Initiative는 이 세 가지 공백을 메우기 위해 세워졌다. 목표는 Lighthouse가 SEO에서 한 역할을 LLMO에서 수행하는 것이다 — 방법론을 공개하고, 도구를 제공하며, 커뮤니티가 그 위에 쌓아 올리도록 둔다.
...
- 서적: [전체 도서 목록 (kenimoto.dev/books)](https://kenimoto.dev/books/)
