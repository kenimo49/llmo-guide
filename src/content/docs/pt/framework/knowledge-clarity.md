...
Coloque conclusões e fatos-chave primeiro. LLMs dão mais peso ao conteúdo inicial de uma seção do que a detalhes enterrados ao final.

### 5. Uma Ideia por Parágrafo
Parágrafos curtos e focados são mais fáceis para a IA processar e atribuir corretamente.
