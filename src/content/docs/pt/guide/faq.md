    ...
    content: |
      {
        ...
        "mainEntity": [
          ...
          {"@type": "Question", "name": "Quanto tempo leva implementar LLMO?", "acceptedAnswer": {"@type": "Answer", "text": "Uma linha de base mínima de LLMO (llms.txt, /ai/ Markdown, robots.txt permitindo GPTBot/ClaudeBot/PerplexityBot, JSON-LD em páginas-chave) leva cerca de 30 minutos em um site pequeno. Atingir 16/18 no framework LLMO normalmente leva algumas semanas de trabalho incremental."}},
...
- **Algumas semanas**: atingir 16/18 no [framework LLMO](/pt/framework/overview/).
...
Sim. Cada componente é um arquivo estático. Este site é Astro estático no GitHub Pages, 18/18.
