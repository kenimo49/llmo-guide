...
Put conclusions and key facts first. LLMs weight early content in a section more heavily than buried details.

### 5. One Idea Per Paragraph
Short, focused paragraphs are easier for AI to parse and attribute correctly.
