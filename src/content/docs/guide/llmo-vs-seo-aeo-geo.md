...
| **Framework** | Well-established | Informal | Research-focused | LLMO Framework (5 components) |
| **Scope** | Web search | Narrow (answers only) | Narrow (generative search) | Broad (all LLM contexts) |

## The Relationship

LLMO includes approaches such as AEO and GEO, while extending beyond search to cover all contexts where LLMs interact with web content.
