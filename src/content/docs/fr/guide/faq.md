...
- **Quelques semaines** : atteindre 13/15 sur le [framework LLMO](/fr/framework/overview/).
...
Oui. Chaque composant est un fichier statique. Ce site est un site Astro statique sur GitHub Pages, 15/15.
