...
LLMO optimiza los tres caminos simultáneamente. Los [seis componentes](/es/framework/overview/) del LLMO Framework abordan aspectos específicos de estos caminos de descubrimiento.
