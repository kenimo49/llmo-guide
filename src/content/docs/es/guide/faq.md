    ...
    content: |
      {
        ...
        "mainEntity": [
          ...
          {"@type": "Question", "name": "¿Cuánto toma implementar LLMO?", "acceptedAnswer": {"@type": "Answer", "text": "Una línea base mínima de LLMO (llms.txt, /ai/ Markdown, robots.txt permitiendo GPTBot/ClaudeBot/PerplexityBot, JSON-LD en páginas clave) toma alrededor de 30 minutos en un sitio pequeño. Alcanzar 16/18 en el framework LLMO típicamente toma unas semanas de trabajo incremental."}},
...
- **Unas semanas**: alcanzar 16/18 en el [framework LLMO](/es/framework/overview/).
...
Sí. Cada componente es un archivo estático. Este sitio es Astro estático en GitHub Pages, 18/18.
